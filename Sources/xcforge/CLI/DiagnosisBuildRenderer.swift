...
enum DiagnosisBuildRenderer {
    static func render(_ result: DiagnosisBuildResult) -> String {
        ...
        if let summary = result.summary {
            ...
            lines.append("  counts: errors=\(summary.observedEvidence.errorCount), warnings=\(summary.observedEvidence.warningCount), analyzer_warnings=\(summary.observedEvidence.analyzerWarningCount)")
