...
public enum LogTools {
    ...
    private static func readLogsImpl(_ input: ReadLogsInput, env: Environment) async -> CallTool.Result {
        let last = input.last
    ...
    private static func waitForLogImpl(_ input: WaitForLogInput, env: Environment) async -> CallTool.Result {
