...
enum DiagnoseTools {
    ...
    public static let tools: [Tool] = [
        Tool(
            ...
            inputSchema: .object([
                ...
                "properties": .object([
                    ...
                    "scheme": .object(["type": .string("string"), "description": .string("Scheme name. Auto-detected if omitted.")]),
                    "simulator": .object(["type": .string("string"), "description": .string("Simulator UDID or display name. Auto-detected if omitted.")]),
                    "reuse_run_id": .object(["type": .string("string"), "description": .string("Run ID to reuse context from.")]),
                    "configuration": .object(["type": .string("string"), "description": .string("Build configuration (e.g. Debug). Used when resolving app context.")]),
                ]),
            ])
        ),
        Tool(
            ...
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "run_id": .object(["type": .string("string"), "description": .string("Run ID returned by diagnose_start.")]),
                ]),
        ...
        Tool(
            ...
            inputSchema: .object([
                ...
                "properties": .object([
                    "run_id": .object(["type": .string("string"), "description": .string("Run ID returned by diagnose_start.")]),
                    "capture_screenshot": .object(["type": .string("boolean"), "description": .string("Capture a simulator screenshot as part of runtime diagnosis. Default: false")]),
                ]),
                "required": .array([.string("run_id")]),
            ])
        ),
        Tool(
            ...
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "run_id": .object(["type": .string("string"), "description": .string("Run ID to inspect. If omitted, uses the newest active or recent run.")]),
                ]),
            ])
        ),
        Tool(
        ...
        Tool(
            ...
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "run_id": .object(["type": .string("string"), "description": .string("Run ID to rerun validation for.")]),
                    "project": .object(["type": .string("string"), "description": .string("Override the project path for this rerun.")]),
                    "scheme": .object(["type": .string("string"), "description": .string("Override the scheme for this rerun.")]),
                    "simulator": .object(["type": .string("string"), "description": .string("Override the simulator for this rerun.")]),
                    "configuration": .object(["type": .string("string"), "description": .string("Override the build configuration for this rerun.")]),
                ]),
                "required": .array([.string("run_id")]),
            ])
        ),
        Tool(
            ...
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "run_id": .object(["type": .string("string"), "description": .string("Run ID to compare. If omitted, uses the newest active or recent run.")]),
                ]),
            ])
        ),
        Tool(
        ...
        Tool(
            ...
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "run_id": .object(["type": .string("string"), "description": .string("Run ID to inspect. If omitted, uses the newest terminal diagnosis run.")]),
                ]),
            ])
        ),
    ]
    ...
    static func diagnoseStart(_ args: [String: Value]?, session: SessionState) async -> CallTool.Result {
