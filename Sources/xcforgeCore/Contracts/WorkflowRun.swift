...
public struct ResolvedWorkflowContext: Codable, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.configuration = try container.decodeIfPresent(String.self, forKey: .configuration) ?? "Debug"
        self.app = try container.decode(AppContext.self, forKey: .app)
        self.simulatorPreparation = try container.decodeIfPresent(WorkflowSimulatorPreparation.self, forKey: .simulatorPreparation)
    }
}
...
public struct WorkflowSimulatorPreparation: Codable, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.initialState = try container.decodeIfPresent(String.self, forKey: .initialState) ?? finalState
...
public struct WorkflowRunRecord: Codable, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.resolvedContext = try container.decode(ResolvedWorkflowContext.self, forKey: .resolvedContext)
        self.diagnosisSummary = try container.decodeIfPresent(BuildDiagnosisSummary.self, forKey: .diagnosisSummary)
        self.testDiagnosisSummary = try container.decodeIfPresent(TestDiagnosisSummary.self, forKey: .testDiagnosisSummary)
        self.runtimeSummary = try container.decodeIfPresent(RuntimeDiagnosisSummary.self, forKey: .runtimeSummary)
        self.environmentPreflight = try container.decodeIfPresent(WorkflowEnvironmentPreflight.self, forKey: .environmentPreflight)
        self.contextProvenance = try container.decodeIfPresent(WorkflowContextProvenance.self, forKey: .contextProvenance)
        self.recoveryHistory = try container.decodeIfPresent([WorkflowRecoveryRecord].self, forKey: .recoveryHistory) ?? []
        self.evidence = try container.decodeIfPresent([WorkflowEvidenceRecord].self, forKey: .evidence) ?? []
        self.attemptHistory = try container.decodeIfPresent([WorkflowAttemptSnapshot].self, forKey: .attemptHistory) ?? []
        self.actionHistory = try container.decodeIfPresent([WorkflowActionRecord].self, forKey: .actionHistory) ?? []
    }
}
...
public struct DiagnosisBuildResult: Codable, Sendable, Equatable {
    ...
    public var isSuccessfulDiagnosis: Bool {
        status == .succeeded && runId != nil && attemptId != nil && resolvedContext != nil && summary != nil
    }
}
...
public struct DiagnosisStatusResult: Codable, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.resolvedContext = try container.decodeIfPresent(ResolvedWorkflowContext.self, forKey: .resolvedContext)
...
public struct DiagnosisInspectResult: Codable, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.actionHistory = try container.decodeIfPresent([WorkflowActionRecord].self, forKey: .actionHistory) ?? []
        self.evidence = try container.decodeIfPresent([WorkflowEvidenceRecord].self, forKey: .evidence) ?? []
        self.evidenceCompleteness = try container.decodeIfPresent(DiagnosisInspectEvidenceCompleteness.self, forKey: .evidenceCompleteness)
        self.failure = try container.decodeIfPresent(WorkflowFailure.self, forKey: .failure)
        self.followOnAction = try container.decodeIfPresent(WorkflowFollowOnAction.self, forKey: .followOnAction)
        self.persistedRunPath = try container.decodeIfPresent(String.self, forKey: .persistedRunPath)
    }
...
public extension WorkflowEvidenceRecord {
    var producingWorkflowStep: String {
        switch phase {
        case .diagnosisStart:
...
public extension WorkflowRunRecord {
    var latestSnapshot: WorkflowAttemptSnapshot {
    ...
    var latestRecoveryRecord: WorkflowRecoveryRecord? {
        recoveryHistory.last
    }

    var backfilledAttemptHistory: [WorkflowAttemptSnapshot] {
    ...
    func evidence(forAttemptId attemptId: String) -> [WorkflowEvidenceRecord] {
        evidence.filter { $0.attemptId == attemptId }
    }

    func attemptSnapshot(forAttemptId attemptId: String, phase: WorkflowPhase? = nil) -> WorkflowAttemptSnapshot? {
...
public extension WorkflowRecoveryIssue {
    var label: String {
        rawValue.replacingOccurrences(of: "_", with: " ")
    }
}

public extension WorkflowRecoveryAction {
    var label: String {
        rawValue.replacingOccurrences(of: "_", with: " ")
    }
}
