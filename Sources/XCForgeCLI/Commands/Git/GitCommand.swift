...
struct GitStatus: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "status",
...
struct GitDiff: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "diff",
...
struct GitLog: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "log",
...
struct GitCommit: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "commit",
...
struct GitBranch: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "branch",
