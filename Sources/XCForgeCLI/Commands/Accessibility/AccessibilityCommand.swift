...
struct AccessibilityDynamicType: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
...
struct AccessibilityLocalization: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
  ...
  @Option(
    help:
      "Comma-separated locale identifiers. Use 'all' for 10 common locales. Default: en,de,ja,ar,he"
  )
  var locales: String?
