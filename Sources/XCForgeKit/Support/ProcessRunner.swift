...
extension ShellExecutor {
  ...
  public func git(_ arguments: [String], workingDirectory: String, timeout: TimeInterval = 30)
    async throws -> ShellResult
  {
...
public struct LiveShell: ShellExecutor {
  ...
  public func git(_ arguments: [String], workingDirectory: String, timeout: TimeInterval)
    async throws -> ShellResult
  {
...
public enum Shell {
  ...
  public static func git(
    _ arguments: [String], workingDirectory: String, timeout: TimeInterval = 30
  ) async throws -> ShellResult {
    try await run(
      "/usr/bin/git", arguments: arguments, workingDirectory: workingDirectory, timeout: timeout)
  }
}
