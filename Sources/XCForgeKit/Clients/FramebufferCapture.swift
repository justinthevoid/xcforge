...
enum FramebufferCapture {
  ...
  enum CaptureError: Error, CustomStringConvertible {
    ...
    var description: String {
      ...
      case .permissionDenied:
        return
          "Screen Recording permission required. Grant it to Terminal/IDE in System Settings → Privacy → Screen Recording"
  ...
  static func captureInline(
    ...
    base64: String, dataSize: Int, width: Int, height: Int, pointWidth: Int, pointHeight: Int,
    method: String
  ) {
    ...
    if CoreSimCapture.isAvailable {
      do {
        ...
        return (
          data.base64EncodedString(), data.count, cgImage.width, cgImage.height, ptSize.w, ptSize.h,
          "burst"
        )
      } catch {
