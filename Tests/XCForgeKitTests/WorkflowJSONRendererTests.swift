...
struct WorkflowJSONRendererTests {
  ...
  @Test(
    "renderJSON encodes structured failure evidence with observed, inferred, and recoverability")
  func renderJSONEncodesStructuredFailureEvidence() throws {
    ...
    #expect(
      inferred["summary"] as? String
        == "Build errors must be resolved before diagnosis can proceed.")
  ...
  func renderJSONSchemaVersionAcrossAllTypes() throws {
    ...
    try assertSchemaVersion(
      DiagnosisStartResult(
        status: .succeeded, runId: "r", attemptId: "a", resolvedContext: context, failure: nil,
        persistedRunPath: nil), label: "StartResult")
    try assertSchemaVersion(
      DiagnosisBuildResult(
        status: .failed, runId: "r", attemptId: "a", resolvedContext: nil, summary: nil,
        failure: nil, persistedRunPath: nil), label: "BuildResult")
    try assertSchemaVersion(
      DiagnosisTestResult(
        status: .succeeded, runId: "r", attemptId: "a", resolvedContext: nil, summary: nil,
        failure: nil, persistedRunPath: nil), label: "TestResult")
    try assertSchemaVersion(
      DiagnosisRuntimeResult(
        status: .succeeded, runId: "r", attemptId: "a", resolvedContext: nil, summary: nil,
        failure: nil, persistedRunPath: nil), label: "RuntimeResult")
    try assertSchemaVersion(
      DiagnosisStatusResult(
        phase: nil, status: nil, runId: nil, attemptId: nil, resolvedContext: nil, summary: nil,
        failure: nil, persistedRunPath: nil), label: "StatusResult")
    try assertSchemaVersion(
      DiagnosisVerifyResult(
        phase: nil, status: nil, outcome: nil, runId: nil, attemptId: nil, sourceAttemptId: nil,
        resolvedContext: nil, summary: nil, buildSummary: nil, testSummary: nil, evidence: [],
        failure: nil, persistedRunPath: nil), label: "VerifyResult")
    try assertSchemaVersion(
      DiagnosisCompareResult(
        phase: nil, status: nil, outcome: nil, runId: nil, attemptId: nil, sourceAttemptId: nil,
        priorAttempt: nil, currentAttempt: nil, changedEvidence: [], unchangedBlockers: [],
        failure: nil, persistedRunPath: nil), label: "CompareResult")
    try assertSchemaVersion(
      DiagnosisFinalResult(
        phase: nil, status: nil, runId: nil, attemptId: nil, sourceAttemptId: nil, summary: nil,
        currentAttempt: nil, sourceAttempt: nil, comparison: nil, failure: nil,
        persistedRunPath: nil), label: "FinalResult")
    try assertSchemaVersion(
      DiagnosisEvidenceResult(
        phase: nil, status: nil, evidenceState: nil, runId: nil, attemptId: nil,
        resolvedContext: nil, buildSummary: nil, testSummary: nil, runtimeSummary: nil,
        evidence: [], failure: nil, persistedRunPath: nil), label: "EvidenceResult")
    try assertSchemaVersion(
      DiagnosisInspectResult(
        phase: nil, status: nil, runId: nil, attemptId: nil, resolvedContext: nil,
        contextProvenance: nil, evidenceCompleteness: nil, failure: nil, persistedRunPath: nil),
      label: "InspectResult")
  }
