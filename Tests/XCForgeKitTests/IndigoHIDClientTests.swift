...
struct IndigoHIDClientTests {
    ...
    func iphone16Pro() {
        let dims = IndigoHIDClient.screenDimensions(for: "com.apple.CoreSimulator.SimDeviceType.iPhone-16-Pro")
    ...
    func iphoneSE() {
        let dims = IndigoHIDClient.screenDimensions(for: "com.apple.CoreSimulator.SimDeviceType.iPhone-SE-3rd-generation")
    ...
    func iphone16ProMax() {
        let dims = IndigoHIDClient.screenDimensions(for: "com.apple.CoreSimulator.SimDeviceType.iPhone-16-Pro-Max")
    ...
    func iphone15() {
        let dims = IndigoHIDClient.screenDimensions(for: "com.apple.CoreSimulator.SimDeviceType.iPhone-15")
    ...
    func iPadPro12() {
        let dims = IndigoHIDClient.screenDimensions(for: "com.apple.CoreSimulator.SimDeviceType.iPad-Pro-12-9-inch-6th-generation")
    ...
    func unknownDevice() {
        let dims = IndigoHIDClient.screenDimensions(for: "com.apple.CoreSimulator.SimDeviceType.FutureDevice-99")
        #expect(dims.width == 393)
        #expect(dims.height == 852)
        #expect(dims.scale == 3.0)
    }
