...
struct TestFilteringDiagnosticsTests {
    ...
    private let sampleTests = TestTools.ListTestsResult(
        tests: [
            TestTools.TestIdentifier(target: "AppTests", className: "LoginTests", methodName: "testValidLogin", fullIdentifier: "AppTests/LoginTests/testValidLogin"),
            TestTools.TestIdentifier(target: "AppTests", className: "LoginTests", methodName: "testInvalidLogin", fullIdentifier: "AppTests/LoginTests/testInvalidLogin"),
            TestTools.TestIdentifier(target: "AppTests", className: "BackfillTests", methodName: "testBackfillCritiques", fullIdentifier: "AppTests/BackfillTests/testBackfillCritiques"),
            TestTools.TestIdentifier(target: "AppTests", className: "BackfillTests", methodName: "testBackfillPhotos", fullIdentifier: "AppTests/BackfillTests/testBackfillPhotos"),
            TestTools.TestIdentifier(target: "CoreTests", className: "NetworkTests", methodName: "testFetch", fullIdentifier: "CoreTests/NetworkTests/testFetch"),
        ],
        targetCount: 2,
        classCount: 3,
        testCount: 5
    ...
    private func makeTestResult(totalCount: Int = 3, passedCount: Int = 3, failedCount: Int = 0) -> TestTools.BuildAndTestResult {
    ...
    func buildAndTestFilterTestplanWarning() {
        let result = TestTools.formatBuildAndTest(makeTestResult(), testplan: "quick", filter: "SomeTest")
        let text = resultText(result)
